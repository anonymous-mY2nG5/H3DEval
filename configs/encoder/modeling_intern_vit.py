...
class InternVisionModel(PreTrainedModel):
    ...
    def __init__(self, config: InternVisionConfig):
        ...
        self.mlp1 = nn.Sequential(
            ...
            nn.Linear(vit_hidden_size * int(1 / self.downsample_ratio) ** 2, mlp_hidden_size),
            nn.GELU(),
            nn.Linear(mlp_hidden_size, mlp_hidden_size)
        )
        self.mlp2 = nn.Sequential(
            nn.LayerNorm(mlp_hidden_size),
            nn.Linear(mlp_hidden_size, vit_hidden_size),
            nn.GELU(),
    ...
    def merge_tokens(self, x, target_num_token):
        ...
        head = self.config.num_attention_heads
    ...
    def forward(
        ...
        vit_embeds = encoder_outputs.last_hidden_state
        ...
        vit_embeds = self.mlp2(vit_embeds)
